    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(_app_router__WEBPACK_IMPORTED_MODULE_5__["MainRouter"], { onSameUrlNavigation: 'reload' })
            ],
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent() {
        ...
        this.checkUserToken = function () {
            _this.activeNav = window.localStorage.getItem('user-token') ? _this.loggedNav : _this.unLoggedNav;
            _this.userIsConnected = window.localStorage.getItem('user-token') ? true : false;
        };
...
var AuthService = /** @class */ (function () {
    function AuthService(HttpClient) {
        ...
        this.register = function (userData) {
            ...
            return _this.HttpClient.post('https://mcba.dwsapp.io/api/auth/register', userData, { headers: myHeader }).toPromise()
                .then(_this.getData)
        ...
        this.login = function (userData) {
            var myHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            myHeader.append('Content-type', 'application/json');
            return _this.HttpClient.post('https://mcba.dwsapp.io/api/auth/login', userData, { headers: myHeader }).toPromise()
                .then(_this.getData)
                .catch(_this.handleError);
        };
        // Method authenticate post
        this.authenticate = function () {
            var myHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', "Bearer " + window.localStorage.getItem('user-token'));
            return _this.HttpClient.get('https://mcba.dwsapp.io/api/user/me', { headers: myHeader }).toPromise()
                .then(_this.getData)
                .catch(_this.handleError);
        };
    }
...
module.exports = __webpack_require__(/*! C:\Users\Corentin\Documents\web2\angular\ANGclient\src\main.ts */"./src/main.ts");
